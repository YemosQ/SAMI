...
public class RellenarTablas {
    ...
    public ObservableList<DatosTablasDAO> datosedes(String codigosede) {
        try {
            ...
            Connection con= conexion.conectar();
            Statement stm=con.createStatement();
            ResultSet rs = stm.executeQuery("SELECT sami.tb_sede.CodEmp, sami.tb_sede.CodSede, sami.tb_sede.NomSede, sami.tb_sede.idpaises, sami.tb_sede.CodDepto, sami.tb_sede.CodMun, sami.tb_sede.Direc, sami.tb_sede.Telef, sami.tb_sede.CelCont, sami.tb_sede.CelWApp, sami.tb_sede.Lunes, sami.tb_sede.Martes, sami.tb_sede.Miercoles, sami.tb_sede.Jueves, sami.tb_sede.Viernes, sami.tb_sede.Sabado, sami.tb_sede.Domingo, sami.tb_sede.HrsLab, sami.tb_sede.HrIng, sami.tb_sede.HrEgr, sami.tb_sede.HrIniDs, sami.tb_sede.HrFinDs, sami.tb_sede.HrsLabEnfe, sami.tb_sede.HrsSemEnf, sami.tb_sede.HrsMesEnf, sami.tb_sede.EstCodGen, sami.tb_estgen.DescEstGen FROM sami.tb_sede join sami.tb_estgen on sami.tb_estgen.CodGen = sami.tb_sede.EstCodGen join sami.tb_emp on sami.tb_emp.CodEmp = sami.tb_sede.CodEmp where CodSede = 'S01'");
